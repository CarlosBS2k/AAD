package com.carlos.programacionfuncional;
...
import com.carlos.programacionfuncional.entidades.Usuario;
...
static List<Usuario> usuarios = new ArrayList<Usuario>();
	...
	public static void partitioningBy() {
		Map<Boolean,List<Usuario>> separados = usuarios.stream().collect(Collectors.partitioningBy(e-> e.getSueldo() > 10000));
		System.out.println("Ganan más de 10000");
		separados.get(true).forEach(e->System.out.println(e));
		System.out.println("Ganan menos de 10000");
		separados.get(false).forEach(e->System.out.println(e));
		
	}
	
	public static void groupingby() {
		Map<Character, List<Usuario>> listaLetras = usuarios.stream().collect(Collectors.groupingBy(e-> e.getNombre().charAt(0)));
		listaLetras.get('P').forEach(e->System.out.println(e));
		System.out.println(listaLetras.containsKey('A') ? "Hay personas que empiezan por A" : "No hay personas que empiecen por A");
